...
NDiplomacy = {
	...
	TENSION_GENERATE_WARGOAL = 0,					-- Amount of tension generated by generating a wargoal against a country
...
NCountry = {
	...
	DAYS_OF_WAR_BEFORE_SURRENDER = 100000,				-- Number of days a war has to have existed before anyone can surrender in it

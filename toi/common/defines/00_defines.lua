...
NDiplomacy = {
	...
	TENSION_STATE_VALUE = 4,						-- Tension value gained by annexing one state
	TENSION_CIVIL_WAR_IMPACT = 0.1,					-- civil war multiplier on tension.
	TENSION_NO_CB_WAR = 2.5,							-- Amount of tension generated by a no-CB wargoal
	...
	TENSION_GENERATE_WARGOAL = 12,					-- Amount of tension generated by generating a wargoal against a country
	...
	TENSION_GUARANTEE = -3,
	TENSION_FACTION_JOIN = 0.5,
	TENSION_JOIN_ATTACKER = 1,						-- scale of the amount of tension added when country joins attacker side
	TENSION_PEACE_FACTOR = 0.25,					-- scale of the amount of tension (from war declaration) reduced when peace is completed.
	TENSION_LIBERATE = -1.25,							-- Amount of tension generated by liberating a country. 
...
NBuildings = {
	...
	NAVALBASE_REPAIR_MULT = 0.025,		-- Each level of navalbase building repairs X strength. The value is spread on all ships needed reparation. Fe Navalbase lvl 5 x 0.5 str repair = 2.5 str repaired over 10 ships, so each ship repair hourly 0.25 str.
...
NMilitary = {
	...
	BASE_LEADER_TRAIT_GAIN_XP = 0.45,			   -- Base xp gain for traits per hour.
...
NAI = {
	...
	MAX_THREAT_FOR_FIRST_YEAR_CIVILIAN_MODE = 75, -- above this threshold, ai will leave first year civilian factory mode which bumps it civilian factory scores while building
